...
print(
    f"Mi perro se llama {Rufo.name}, es de raza {Rufo.race}, color {Rufo.color} y cuesta ${Rufo.price}.\n"
    f"{Cosi.name} es un perro {Cosi.size} de color {Cosi.color}.\n"
    f"La película '{Interestellar.name}' tiene una calificación de {Interestellar.rating} y su actor principal es {Interestellar.mainactor}.\n"
    f"'{Parasite.name}' pertenece al género {Parasite.gender} y ganó ${Parasite.benefit} en taquilla.\n"
    f"El equipo {Real_Madrid.name} ha ganado {Real_Madrid.championstitles} Champions y su leyenda es {Real_Madrid.legend}.\n"
    f"{FC_Barcelona.name} es un equipo con {FC_Barcelona.leaguetitles} títulos de liga y una valoración de {FC_Barcelona.rating} estrellas."
)
